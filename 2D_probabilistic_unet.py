...
class AxisAlignedConvGaussian(nn.Module):
    ...
    def __init__(self, input_channels, num_filters, no_convs_per_block, latent_dim, initializers, posterior=False):
        ...
        nn.init.normal_(self.conv_layer.bias,mean=0, std=0.001)
    ...
    def forward(self, input, segm=None):
        ...
        scale = F.softplus(log_sigma) +1e-5
        #This is a multivariate normal with diagonal covariance matrix sigma
        #https://github.com/pytorch/pytorch/pull/11178
        dist = Independent(Normal(loc=mu, scale=scale),1)
        return dist
...
class ProbabilisticUnet(nn.Module):
    ...
    def __init__(self, input_channels=1, num_classes=1, num_filters=[16,32,64,128,192], latent_dim=6, no_convs_fcomb=4, beta=10.0):
        ...
        self.unet = SwinUnet2D(hidden_dim=96, layers=(2, 2, 18, 2), heads=(3, 6, 12, 24), window_size=[4,4],
